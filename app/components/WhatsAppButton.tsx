...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-8 right-6 z-[100] w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg shadow-black/30 hover:scale-110 transition-transform duration-200"
    >
      <svg
