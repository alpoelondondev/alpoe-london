...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-white/[0.05] bg-bg text-fg">
          ...
          <div className="col-span-4 max-lg:col-span-6 max-md:col-span-1 flex flex-col gap-6">
            ...
            <div className="flex items-center gap-5 mt-2">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="text-white/50 transition hover:text-[#25D366]"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="px-[52px] py-7 flex justify-between items-center border-t border-white/[0.05] text-[11px] tracking-[0.1em] uppercase text-dim max-md:px-6 max-md:flex-col max-md:gap-3 max-md:text-center">
      ...
      <div className="px-[52px] py-4 flex justify-center items-center border-t border-white/[0.05] text-[11px] tracking-[0.1em] uppercase text-dim max-md:px-6">
        <span>
          Made by{" "}
          <a
            href="https://j0e.dev"
