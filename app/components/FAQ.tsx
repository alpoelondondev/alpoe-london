      ...
      <ScrollReveal>
        <div className="mt-10 flex flex-col items-center gap-3">
          <a
            ...
            className="inline-flex items-center justify-center gap-3 bg-accent px-5 py-2 text-[11px] font-medium uppercase tracking-[0.16em] text-bg transition hover:bg-accent-deep"
          >
